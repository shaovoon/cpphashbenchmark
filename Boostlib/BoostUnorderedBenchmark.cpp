...
BoostUnorderedBenchmark::BoostUnorderedBenchmark(void)
{
	m_szMapName = L"Boost Unordered Map (wstring)";
	m_szMultimapName = L"Boost Unordered Multimap (wstring)";
	m_szSetName = L"Boost Unordered Set (wstring)";
	m_szMultisetName = L"Boost Unordered Multiset (wstring)";
}
...
void BoostUnorderedBenchmark::Initialize(std::vector<std::wstring>* pvecEngDict, std::vector<CString>* pvecEngDictCString)
{
	m_pvecEngDict = pvecEngDict;
}

void BoostUnorderedBenchmark::Destroy()
{
...
bool BoostUnorderedBenchmark::PopulateMap(UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
	if(m_map.size()>0)
		m_map.clear();
...
bool BoostUnorderedBenchmark::PopulateMultimap(UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
...
bool BoostUnorderedBenchmark::PopulateSet(UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
	if(m_set.size()>0)
		m_set.clear();
...
bool BoostUnorderedBenchmark::PopulateMultiset(UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
...
bool BoostUnorderedBenchmark::BenchmarkMap(UINT nRandomSeed, UINT nTotal, UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
	if(pName==NULL)
	{
		if(pLen) *pLen = m_szMapName.length();
...
bool BoostUnorderedBenchmark::BenchmarkMultimap(UINT nRandomSeed, UINT nTotal, UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
	if(pName==NULL)
	{
		if(pLen) *pLen = m_szMultimapName.length();
...
bool BoostUnorderedBenchmark::BenchmarkSet(UINT nRandomSeed, UINT nTotal, UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
	if(pName==NULL)
	{
		if(pLen) *pLen = m_szSetName.length();
...
bool BoostUnorderedBenchmark::BenchmarkMultiset(UINT nRandomSeed, UINT nTotal, UINT* pTimeTaken, volatile UINT* pProgress, wchar_t* pName, USHORT* pLen)
{
	if(pName==NULL)
	{
		if(pLen) *pLen = m_szMultisetName.length();
